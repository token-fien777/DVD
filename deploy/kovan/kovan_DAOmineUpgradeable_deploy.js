...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying DAOmineUpgradeable on Kovan...");
  ...
  console.log("Now deploying DAOmineUpgradeableProxy on Kovan...");
...
module.exports.tags = ["kovan_DAOmineUpgradeable_deploy"];
